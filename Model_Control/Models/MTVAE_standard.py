...
## MODELO SIN FUNCIÓN DE COSTO INTERNA
...
def MTVAE(nb_classes, Chans = 22, Samples = 250, dropoutRate = 0.5, l1 = 0, l2 = 0):
    ...
    -----------------------------------
    nb_classes = define el número de clases
    ...
    ## ENCODER
    input_main   = Input((Chans, Samples, 1)) ## TENGO QUE AGREGARLE UN NUEVO AXIS?
    ...
    ##MODELO DE CLASIFICACIÓN DESDE EL ESPACIO LATENTE
    ...
    softmax      = Activation('softmax',name='out_activation')(flat) ## SALIDA RED DENSA
    ...
    model = Model(inputs=input_main, outputs=[block2,softmax]) ## TENDRIA MIS 2 MODELOS, EL DE CLASIFICACIÓN DESPRENDIDO DEL ESPACIO LATENTE Y LA ESTRUCTURA DE RECONSTRUCCIÓN
